...
@implementation WJQShowImageCellTwo
{
    UIView  *gapline;
    UILabel *titleLbl;
}
...
- (void)initCellWithModel:(NSDictionary *)model {
    ...
    CGFloat signTextH  = [WJQShowImageCellTwo getSignTextHeightWithSignText:signText];
    if (signTextH>0)
    {
